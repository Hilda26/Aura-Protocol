...
// check_interval and resolve_dispute both run a real non-deterministic
// consensus round and can legitimately land on INSUFFICIENT_DATA rather
// than a hard failure -- the rollback-pattern check below is skipped for
// them, same reasoning as CoverPool/GroundTruth's clients for their single
// nondet method.
const NONDET_METHODS = new Set(["check_interval", "resolve_dispute"]);
